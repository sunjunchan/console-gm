export default {
  ...
  login: '登录',
  survey_page: '概况',
  service_information_page:'服务信息',
  application_information_page:'应用信息',
  user_center_page:'用户中心',
  components: '组件',
  count_to_page: '数字渐变',
  tables_page: '多功能表格',
  ...
  multilevel: '多级菜单',
  directive_page: '服务信息',
  directive_page1: '用户中心',
  directive_page2: '应用信息',
  level_1: 'Level-1',
  level_2: 'Level-2',
  level_2_1: 'Level-2-1',
  level_2_3: 'Level-2-3',
